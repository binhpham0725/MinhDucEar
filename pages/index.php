...
.right-lyric-line.active-lyric {
  color: #ffffff !important;
  background: rgba(84, 216, 232, 0.22) !important;
  border: 1.5px solid rgba(84, 216, 232, 0.85) !important;
  border-radius: 12px !important;
  box-shadow: 0 0 18px rgba(84, 216, 232, 0.4), inset 0 0 6px rgba(84, 216, 232, 0.15) !important;
  text-shadow: 0 0 12px rgba(84, 216, 232, 0.9), 0 0 24px rgba(84, 216, 232, 0.5) !important;
...
#floating-lyrics-single-line {
  ...
  text-shadow: 0 0 12px rgba(84, 216, 232, 0.9), 0 0 24px rgba(84, 216, 232, 0.45) !important;
}

#btn-close-floating-lyrics {
  color: rgba(255, 255, 255, 0.75) !important;
}
#btn-close-floating-lyrics:hover {
  color: #ffffff !important;
...
#hero-cover-container:hover #hero-track-cover {
  ...
  <div class="hidden md:block absolute left-1/2 -translate-x-1/2 w-80 md:w-96 lg:w-[460px] max-w-[calc(100%-460px)] z-20">
    <div class="relative flex items-center h-9 w-full">
      ...
      <button type="button" id="global-search-btn" class="absolute left-1.5 top-1/2 -translate-y-1/2 w-7 h-7 flex items-center justify-center text-outline hover:text-primary hover:bg-white/10 rounded transition-colors cursor-pointer z-20 pointer-events-auto" title="Tìm kiếm">
        <svg class="w-4 h-4 pixel-icon" fill="none" viewBox="0 0 16 16">
    ...
    <div class="flex flex-col gap-3">
      ...
      <div class="space-y-1.5">
        <div class="px-2 font-label-caps text-[10px] text-outline uppercase tracking-wider flex justify-between items-center font-silkscreen">
          <span>PLAYLISTS</span>
          <button type="button" id="btn-mobile-playlist-add" class="w-5 h-5 flex items-center justify-center rounded bg-surface-container-high hover:bg-surface-container-highest text-secondary hover:text-white border border-outline-variant/30 pixel-border-sm transition-all hover:scale-110 cursor-pointer" title="Tạo playlist mới (+)">
...
<section id="home-made-for-you-section" class="flex flex-col justify-between shrink-0">
  <div class="flex items-center justify-between shrink-0 mb-2">
    <div>
      <span id="home-made-for-you-title" class="font-silkscreen text-[11px] text-secondary uppercase tracking-widest flex items-center gap-2 font-bold">
        <span class="w-2 h-2 bg-secondary"></span>ĐỀ XUẤT CHO BẠN / MADE FOR YOU
      </span>
      <p class="text-[11px] text-gray-400 font-sans mt-0.5">Tuyển chọn các giai điệu YouTube Music phù hợp theo tâm trạng hiện tại</p>
    </div>
    <button type="button" id="btn-home-see-more-explore" class="font-pixel text-[8px] text-secondary hover:text-white bg-surface-container-high hover:bg-secondary/20 px-2.5 py-1 rounded pixel-border-sm transition-all cursor-pointer flex items-center gap-1 group" onclick="if(window.minhDucPlayer) window.minhDucPlayer.switchView('explore');" title="Xem thêm trong Khám Phá">
      <span>xem thêm</span><span class="group-hover:translate-x-0.5 transition-transform">→</span>
    </button>
  </div>
...
<section id="home-trending-section" class="flex flex-col justify-between shrink-0">
  ...
  <div id="sidebar-normal-content" class="flex flex-col gap-space-sm h-full transition-opacity duration-300">
    <div class="rounded-xl bg-surface-container-low/80 p-3 pixel-border flex flex-col justify-between gap-2 overflow-hidden notranslate" translate="no">
      <div class="flex items-center justify-between">
        <span class="font-silkscreen text-[9px] text-secondary flex items-center gap-1.5 font-bold">
          <svg class="w-3.5 h-3.5 pixel-icon text-secondary shrink-0" fill="currentColor" viewBox="0 0 16 16">
            <rect x="2" y="9" width="3" height="5"></rect>
            <rect x="6.5" y="4" width="3" height="10"></rect>
            <rect x="11" y="7" width="3" height="7"></rect>
          </svg>
          THỐNG KÊ TUẦN
        </span>
        <span id="sidebar-stat-weekly-total" class="px-1.5 py-0.5 rounded bg-primary-container/20 text-primary border border-primary/30 font-pixel text-[7px]">TỔNG: 0 HRS</span>
      </div>
      <div class="p-2 bg-surface-container-lowest/90 rounded pixel-border-sm flex flex-col gap-2">
        <div class="flex items-center justify-between gap-2">
          <div class="flex items-center gap-1.5">
            <span id="sidebar-stat-weekly-hours" class="flex items-center gap-1 font-silkscreen text-xs text-white">
              <span class="px-1.5 py-0.5 rounded bg-surface-container-high/90 text-white font-bold border border-outline-variant/30 leading-none">0<span class="text-secondary text-[10px] ml-0.5">h</span></span>
              <span class="px-1.5 py-0.5 rounded bg-surface-container-high/90 text-white font-bold border border-outline-variant/30 leading-none">0<span class="text-secondary text-[10px] ml-0.5">m</span></span>
              <span class="px-1.5 py-0.5 rounded bg-secondary/15 text-secondary font-bold border border-secondary/40 leading-none">00<span class="text-[10px] ml-0.5">s</span></span>
            </span>
            <span id="sidebar-stat-weekly-trend" class="font-silkscreen text-[8px] text-[#54d8e8] font-bold px-1 py-0.5 rounded bg-secondary/10 border border-secondary/20 hidden">--</span>
          </div>
          <span id="sidebar-stat-daily-avg" class="font-silkscreen text-[8px] text-outline shrink-0">TB: 0h/ngày</span>
        </div>
      ...
      <div class="flex flex-col gap-1.5">
        <div class="flex items-center justify-between px-1">
          <span class="font-silkscreen text-[8px] text-secondary flex items-center gap-1.5 font-bold">
            <svg class="w-3 h-3 pixel-icon text-secondary shrink-0" fill="currentColor" viewBox="0 0 16 16">
              <rect x="2" y="2" width="2" height="3"></rect>
              <rect x="6" y="2" width="8" height="2"></rect>
              <rect x="2" y="7" width="2" height="3"></rect>
              <rect x="6" y="7" width="8" height="2"></rect>
              <rect x="2" y="12" width="2" height="3"></rect>
              <rect x="6" y="12" width="8" height="2"></rect>
            </svg>
            TOP 3 NGHE NHIỀU NHẤT
          </span>
          <span class="font-silkscreen text-[7px] text-outline uppercase">Tuần này</span>
        </div>
...
<footer class="h-16 shrink-0 bg-surface-container-lowest/90 backdrop-blur-3xl border-t border-outline-variant/30 px-2.5 sm:px-space-lg flex items-center justify-between z-50 w-full max-w-full">
  ...
  <div class="flex sm:hidden items-center gap-1 shrink-0 ml-2">
    ...
    <button type="button" id="mobile-mini-lyrics-btn" class="w-8 h-8 rounded text-secondary hover:text-white flex items-center justify-center cursor-pointer relative active:scale-95 transition-all" title="Bật/Tắt Lời bài hát">
...
<div id="floating-lyrics-panel" class="fixed left-1/2 -translate-x-1/2 bottom-[84px] sm:bottom-[84px] z-[999] max-w-[94vw] sm:max-w-2xl bg-[#111116]/95 backdrop-blur-xl border border-secondary/60 rounded-full shadow-[0_4px_25px_rgba(0,0,0,0.85),0_0_20px_rgba(84,216,232,0.3)] transition-all duration-300 transform translate-y-4 opacity-0 pointer-events-none px-4 py-2 text-on-surface flex items-center justify-between gap-3 select-none">
  ...
  <button type="button" id="btn-close-floating-lyrics" class="text-gray-300 hover:text-white p-0.5 rounded transition-colors cursor-pointer text-xs shrink-0 ml-1 leading-none" title="Đóng thanh lời (✕)">✕</button>
</div>
  ...
  <div class="bg-[#121217] border-2 border-[#54d8e8] rounded-2xl max-w-md w-full p-6 shadow-[0_0_50px_rgba(84,216,232,0.35)] relative text-on-surface">
    ...
    <div class="mb-4 p-3 bg-[#181822] border border-secondary/30 rounded-xl text-center">
      <div class="font-silkscreen text-[8px] text-secondary mb-2 flex items-center justify-center gap-1.5">
        ...
        <span>ĐĂNG NHẬP CHÍNH THỨC VỚI GOOGLE</span>
      </div>
      <div id="google-gsi-button-slot" class="flex justify-center my-1.5">
      ...
      <p class="font-silkscreen text-[7px] text-gray-400 mt-1">Đồng bộ tự động thư viện và danh sách phát cá nhân</p>
    </div>
...
<div id="modal-add-to-playlist" class="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-md hidden p-4">
  <div class="w-full max-w-sm bg-[#14141d] rounded-2xl pixel-border p-6 shadow-[0_0_50px_rgba(84,216,232,0.3)] relative text-on-surface">
    ...
    <div class="flex items-center justify-between mb-2">
      <p class="font-silkscreen text-[9px] text-gray-300">CHỌN PLAYLIST ĐỂ LƯU:</p>
      <button type="button" id="btn-quick-create-pl-from-modal" class="text-[9px] font-silkscreen text-secondary hover:text-white flex items-center gap-1 transition-colors cursor-pointer px-1.5 py-0.5 rounded bg-secondary/10 border border-secondary/30 hover:bg-secondary/20">
        <span>+ TẠO MỚI</span>
      </button>
    </div>
