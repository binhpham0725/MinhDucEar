...
<div id="google-signin-modal" class="fixed inset-0 z-50 flex items-center justify-center bg-black/85 backdrop-blur-md hidden p-4">
  <div class="bg-[#121217] border-2 border-[#54d8e8] rounded-2xl max-w-md w-full p-6 shadow-[0_0_50px_rgba(84,216,232,0.35)] relative text-on-surface">
    ...
    <!-- Google 1-Click Login Card -->
    <div class="mb-4 p-3 bg-[#181822] border border-secondary/50 rounded-xl text-center shadow-[0_0_20px_rgba(84,216,232,0.15)]">
      ...
      <p class="font-silkscreen text-[7px] text-gray-400 mt-1">Đồng bộ tức thì thư viện cá nhân &amp; không bao giờ bị Google chặn</p>
    </div>

    <div class="relative flex items-center justify-center my-3">
      <div class="border-t border-white/10 w-full"></div>
      <span class="bg-[#121217] px-2 font-silkscreen text-[7px] text-gray-400 uppercase">Hoặc nhập email Google khác</span>
    </div>
    ...
    <form id="form-real-google-login" class="space-y-3">
      ...
      <div>
        ...
        <input id="input-real-google-email" type="email" value="binhpham2k5@gmail.com" placeholder="yourname@gmail.com..." required class="w-full bg-black/60 border border-white/15 rounded-lg px-3 py-2 text-xs text-white focus:outline-none focus:border-secondary font-mono transition-colors">
      </div>
      <div>
        <label class="block font-silkscreen text-[8px] text-gray-400 mb-1">TÊN HIỂN THỊ CỦA BẠN</label>
        <input id="input-real-google-name" type="text" value="PTB Nightcore" placeholder="Tên hiển thị..." class="w-full bg-black/60 border border-white/15 rounded-lg px-3 py-2 text-xs text-white focus:outline-none focus:border-secondary font-mono transition-colors">
      </div>
